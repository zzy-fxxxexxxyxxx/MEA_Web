...
//   // 绘制网格边框和标题
//   drawGridOnPanel1(); // ⚡ 注意 drawGridOnPanel1 也要支持 dpi
...
//       // 坐标映射函数，将波形映射到小坐标系内部
//       const mapX = (val) => rectX + ((val - plotStartTime) / intervalTime) * cellWidth;
//       const mapY = (val) =>
//         rectY + cellHeight - ((val + voltageRange) / (2 * voltageRange)) * cellHeight;
